...
gray2gray = cv.imread("C:/IMAGEPROCESSING/0912/read_gray.jpg", cv.IMREAD_GRAYSCALE)
gray2color = cv.imread("C:/IMAGEPROCESSING/0912/read_gray.jpg", cv.IMREAD_COLOR)
